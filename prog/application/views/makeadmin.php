...
<!-- Mirrored from ekan-admin-templates.multipurposethemes.com/main/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Nov 2018 01:08:32 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="active"><a href="<?php echo base_url('index.php/home/admin');?>"><i class="header nav-small-cap"></i>MAKE AN ADMIN</a></li> <br>
		</div>
    </section>
  </aside>
